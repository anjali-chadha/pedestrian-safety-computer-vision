...
def denoise_overlapped_strides(strides=(3,3)): #1 2 4 11
	...
	while True:
		...
		reconstructed  = theano.function([],sda.logLayer.y_pred,givens={sda.x:test_set_x},on_unused_input='warn')
